...
AddEventHandler('oxydelivery:receiveBigRewarditem', function()
	...
	TriggerClientEvent('inventory:client:ItemBox', source, VRCore.Shared.Items[Config.BigRewarditem], "add")
end)
...
AddEventHandler('oxydelivery:receiveoxy', function()
	...
	TriggerClientEvent('inventory:client:ItemBox', source, VRCore.Shared.Items[Config.Item], "add")
end)
