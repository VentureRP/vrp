...
AddEventHandler('VRCore:Client:OnPlayerLoaded', function()
    ...
    onDuty = VRCore.Functions.GetPlayerData().job.onduty
    isHandcuffed = false
    TriggerServerEvent("VRCore:Server:SetMetaData", "ishandcuffed", false)
    ...
    if VRCore.Functions.GetPlayerData().metadata["tracker"] then
        ...
        TriggerEvent('vr-clothing:client:loadOutfit', trackerClothingData)
    else
...
AddEventHandler('police:client:SendPoliceEmergencyAlert', function()
    ...
    TriggerServerEvent("police:server:SendPoliceEmergencyAlert", streetLabel, pos, VRCore.Functions.GetPlayerData().metadata["callsign"])
    TriggerServerEvent('vr-policealerts:server:AddPoliceAlert', {
        timeOut = 10000,
        ...
        details = {
            [1] = {
                ...
                detail = MyId .. ' | ' .. VRCore.Functions.GetPlayerData().charinfo.firstname .. ' ' .. VRCore.Functions.GetPlayerData().charinfo.lastname,
            },
            [2] = {
