RegisterServerEvent('VRCore:DebugSomething')
AddEventHandler('VRCore:DebugSomething', function(resource, obj, depth)
...
VRCore.Debug = function(resource, obj, depth)
    TriggerEvent('VRCore:DebugSomething', resource, obj, depth)
end

VRCore.ShowError = function(resource, msg)
    print("\x1b[31m["..resource..":ERROR]\x1b[0m "..msg)
end

VRCore.ShowSuccess = function(resource, msg)
