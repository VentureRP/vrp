...
Citizen.CreateThread(function()
    while true do
        ...
        if not notInteressted then
            for k, v in pairs(VRDiving.SellLocations) do
                ...
                if dist < 20 then
                    ...
                    if dist < 1 then
                        ...
                        if IsControlJustPressed(0, 47) then
                            ...
                            VRCore.Functions.Progressbar("sell_coral_items", "Check Pockets To Sell Coral", math.random(2000, 4000), false, true, {}, {}, {}, {}, function() -- Done
                                ClearPedTasks(PlayerPedId())
                                TriggerServerEvent('vr-diving:server:SellCoral')
                                notInteressted = true
