...
RegisterNetEvent('vr-interior:client:SetNewState')
AddEventHandler('vr-interior:client:SetNewState', function(bool)
	IsNew = bool
end)
...
function CreateApartmentFurnished(spawn)
	...
	if IsNew then
		SetTimeout(750, function()
			TriggerEvent('vr-clothes:client:CreateFirstCharacter')
			IsNew = false
		end)
	end
    return { objects, POIOffsets }
