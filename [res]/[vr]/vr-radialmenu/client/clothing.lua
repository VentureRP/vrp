...
RegisterNetEvent('vr-radialmenu:ResetClothing')
AddEventHandler('vr-radialmenu:ResetClothing', ResetClothing)
...
RegisterNetEvent('vr-radialmenu:ToggleClothing')
AddEventHandler('vr-radialmenu:ToggleClothing', ToggleClothing)
...
RegisterNetEvent('vr-radialmenu:ToggleProps')
AddEventHandler('vr-radialmenu:ToggleProps', ToggleProps)
...
function Notify(message, color) -- However you want your notifications to be shown, you can switch it up here.
	VRCore.Functions.Notify(message, color)
end
